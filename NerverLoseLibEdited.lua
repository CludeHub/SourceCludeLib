...
function NEVERLOSE:AddSelectTheme(text1, text2, config)
	...
	local mainFramea = Instance.new("Frame")
	mainFramea.Size = UDim2.new(0, 300, 0, 200)
	mainFramea.Position = UDim2.new(0.5, -150, 0.5, -100)
	mainFramea.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
	mainFramea.BorderSizePixel = 0
	mainFramea.Parent = gui
	...
	outline.Position = UDim2.new(0, 0, 0, 40)
	...
	local function createButton(name, label, posY, color, sourceUrl)
		...
		buttonh.Name = name
		buttonh.Size = UDim2.new(0.8, 0, 0, 40)
		buttonh.Position = UDim2.new(0.1, 0, posY, 0)
		buttonh.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
		buttonh.TextColor3 = Color3.fromRGB(230, 230, 230)
		buttonh.Text = label
		...
		strokeo.Transparency = 0.766
		strokeo.Thickness = 1
		strokeo.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
		strokeo.Parent = buttonh
		...
		circle.Name = "circlecolortheme"
		circle.Size = UDim2.new(0, 28, 0, 28)
		circle.Position = UDim2.new(0, 200, 0, 6)
		circle.BackgroundColor3 = color
		circle.Parent = buttonh
		Instance.new("UICorner", circle).CornerRadius = UDim.new(1, 0)
		local s = Instance.new("UIStroke", circle)
		s.Color = Color3.fromRGB(200, 200, 200)
		s.Transparency = 0.766

		buttonh.MouseButton1Click:Connect(function()
			local originalSize = button.Size
			buttonh:TweenSize(UDim2.new(originalSize.X.Scale, originalSize.X.Offset, 0, 35), Enum.EasingDirection.Out, Enum.EasingStyle.Quad, 0.08, true, function()
				buttonh.TweenSize(originalSize, Enum.EasingDirection.Out, Enum.EasingStyle.Quad, 0.08, true)
			end)
			if sourceUrl and typeof(sourceUrl) == "string" then
	...
	createButton("DarkBtn", text1, 0.35, config.Dark, config.DarkSource)
	createButton("OriginalBtn", text2, 0.6, config.Original, config.OriginalSource)
end
...
dpiDropdown.BackgroundColor3 = NEVERLOSE.Themes.BlackgroundColor
